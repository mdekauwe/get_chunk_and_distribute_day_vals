...
**
** PROGRAM:
**              get_chunk_and_distribute_day_vals
**
** DESCRIPTION:
**              Extract a chunk (num_rows x total_cols) from the AWAP
**              meteorological data and create inputs that GDAY can use. We are
**              going to output the tmax, tmin vals etc, and let GDAY handle
**              the diurnalisation.The code then divides the pixels between
**              processors using the MPI libraries.
**
...
#include "get_chunk_and_distribute_day_vals.h"
